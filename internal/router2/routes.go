...
//	})
func Route(ctx *runtime2.Ctx, props RouteProps) work.Node {
...
//	)
func Routes(ctx *runtime2.Ctx, props RoutesProps, children []work.Node) work.Node {
	outlet := props.Outlet
	if outlet == "" {
		outlet = "default"
	}
	...
	entries := runtime2.UseMemo(ctx, func() []routeEntry {
		return collectRouteEntries(children)
	}, fingerprintChildren(children))

	trie := runtime2.UseMemo(ctx, func() *RouterTrie {
		t := NewRouterTrie()
	...
	matchResult := runtime2.UseMemo(ctx, func() *MatchResult {
