...
func mockComponent(ctx *runtime2.Ctx, match Match, children []work.Node) work.Node {
	return &work.Element{Tag: "div"}
}

func mockComponent2(ctx *runtime2.Ctx, match Match, children []work.Node) work.Node {
