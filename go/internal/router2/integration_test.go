...
func router2UserPage(ctx runtime.Ctx, match Match) h.Node {
	if match.Params["id"] != "" {
...
func router2UseParamsPage(ctx runtime.Ctx, match Match) h.Node {
	params := UseParams(ctx)
	if params["id"] != "" {
		lastUserParam = params["id"]
	}
	return router2UserPage(ctx, match)
}

func router2UsersApp(ctx runtime.Ctx, _ routerIntegrationProps) h.Node {
	return Router(ctx,
		Routes(ctx,
			Route(ctx, RouteProps{Path: "/users/:id", Component: router2UseParamsPage}),
		),
	)
}
...
func TestRouter2UseParamsUpdatesAfterNavigation(t *testing.T) {
	...
	sess := runtime.NewSession(router2UsersApp, routerIntegrationProps{})
	sess.SetPatchSender(func([]diff.Op) error { return nil })

	runtime.InternalSeedSessionLocation(sess, runtime.ParseHref("/users/1"))
...
func router2SearchComponent(ctx runtime.Ctx, _ Match) h.Node {
	searchRenderCount++
...
func router2SearchApp(ctx runtime.Ctx, _ routerIntegrationProps) h.Node {
	return Router(ctx,
		Routes(ctx,
			Route(ctx, RouteProps{Path: "/settings", Component: router2SearchComponent}),
		),
	)
}
...
func TestRouter2UseSearchParamSetter(t *testing.T) {
	searchRenderCount = 0
	sess := runtime.NewSession(router2SearchApp, routerIntegrationProps{})
	sess.SetPatchSender(func([]diff.Op) error { return nil })

	runtime.InternalSeedSessionLocation(sess, runtime.ParseHref("/settings?tab=overview"))
...
func router2NavHome(ctx runtime.Ctx, _ Match) h.Node {
...
func router2NavUser(ctx runtime.Ctx, match Match) h.Node {
	routerNavLastUserID = match.Params["id"]
	return h.Div()
}

func router2NavApp(ctx runtime.Ctx, _ routerIntegrationProps) h.Node {
	return Router(ctx,
		Routes(ctx,
			Route(ctx, RouteProps{Path: "/", Component: router2NavHome}),
			Route(ctx, RouteProps{Path: "/users/:id", Component: router2NavUser}),
		),
	)
}

func router2MetadataPage(ctx runtime.Ctx, match Match) h.Node {
	metadataRenderCount++
...
func router2MetadataApp(ctx runtime.Ctx, _ routerIntegrationProps) h.Node {
	return Router(ctx,
		Routes(ctx,
			Route(ctx, RouteProps{Path: "/users/:id", Component: router2MetadataPage}),
		),
	)
}
...
func TestRouter2NavigateFromEventHandler(t *testing.T) {
	...
	routerNavLastUserID = ""
	sess := runtime.NewSession(router2NavApp, routerIntegrationProps{})
	sess.SetPatchSender(func([]diff.Op) error { return nil })

	runtime.InternalSeedSessionLocation(sess, runtime.ParseHref("/"))
	structured := sess.InitialStructured()
	runtime.InternalClearNavHistory(sess)
...
func router2LinkApp(ctx runtime.Ctx, _ routerIntegrationProps) h.Node {
	return Router(ctx, Link(ctx, LinkProps{To: "/same"}, h.Text("Same")))
}

func TestRouter2LinkNoNavigationOnSameHref(t *testing.T) {
	t.Skip("router2 Link client interception pending")
	sess := runtime.NewSession(router2LinkApp, routerIntegrationProps{})
	sess.SetPatchSender(func([]diff.Op) error { return nil })

	runtime.InternalSeedSessionLocation(sess, runtime.ParseHref("/same"))
	structured := sess.InitialStructured()
	runtime.InternalClearNavHistory(sess)
...
func TestRouter2UseMetadataMergesRouteAndResult(t *testing.T) {
	...
	storeCaptureHook = func(s *RouterStore) { capturedStore = s }
	defer func() { storeCaptureHook = nil }()
	sess := runtime.NewSession(router2MetadataApp, routerIntegrationProps{})
	sess.SetPatchSender(func([]diff.Op) error { return nil })
	runtime.InternalSeedSessionLocation(sess, runtime.ParseHref("/users/42"))
	sess.InitialStructured()
	if err := sess.Flush(); err != nil {
		t.Fatalf("flush error: %v", err)
	}
...
func TestRouter2SessionsIsolated(t *testing.T) {
	sessA := runtime.NewSession(router2NavApp, routerIntegrationProps{})
	sessB := runtime.NewSession(router2NavApp, routerIntegrationProps{})
	for _, sess := range []*runtime.ComponentSession{sessA, sessB} {
		sess.SetPatchSender(func([]diff.Op) error { return nil })
	}
	runtime.InternalSeedSessionLocation(sessA, runtime.ParseHref("/"))
	runtime.InternalSeedSessionLocation(sessB, runtime.ParseHref("/"))
