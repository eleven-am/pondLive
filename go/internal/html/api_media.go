...
func buildMediaEvent(evt dom.Event) MediaEvent {
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnPlay(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnPause(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnEnded(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnSeeking(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnSeeked(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnRateChange(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Video(h.Attach(videoRef), h.Src("/movie.mp4"))
func (a *MediaAPI[T]) OnTimeUpdate(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
...
//
//	return h.Audio(h.Attach(audioRef), h.Src("/music.mp3"))
func (a *MediaAPI[T]) OnVolumeChange(handler func(MediaEvent) dom.Updates) {
	if a.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildMediaEvent(evt)) }
