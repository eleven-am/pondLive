...
func generateElementRefs(specs []tagSpec) {
	...
	b.WriteString("import \"github.com/eleven-am/pondlive/go/internal/dom\"\n\n")
	for _, spec := range specs {
		...
		fmt.Fprintf(&b, "\t*dom.ElementRef[%s]\n", descriptor)
		...
		fmt.Fprintf(&b, "func %s(ref *dom.ElementRef[%s], ctx dom.Dispatcher) *%s {\n", constructor, descriptor, refName)
	...
	for _, spec := range specs {
		...
		fmt.Fprintf(&b, "\treturn dom.AcquireElementRef(ctx, %s{}).(*%s)\n", descriptor, refName)
		b.WriteString("}\n\n")
	}
...
func generatePublicFacade(specs []tagSpec) {
	var b strings.Builder
	b.WriteString("// Code generated by tags_gen.go; DO NOT EDIT.\n")
	b.WriteString("// Package html provides public re-exports from internal/html and internal/dom.\n")
	b.WriteString("package html\n\n")
	b.WriteString("import (\n")
	b.WriteString("\t\"github.com/eleven-am/pondlive/go/internal/dom\"\n")
	b.WriteString("\tinternalhtml \"github.com/eleven-am/pondlive/go/internal/html\"\n")
