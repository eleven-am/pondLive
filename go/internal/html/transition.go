...
func NewTransitionHandler(ref RefListener) *TransitionHandler {
	return &TransitionHandler{ref: ref}
}

// OnTransitionStart registers a handler for the "transitionstart" event.
func (h *TransitionHandler) OnTransitionStart(handler func(TransitionEvent) Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt Event) Updates { return handler(buildTransitionEvent(evt)) }
...
func (h *TransitionHandler) OnTransitionEnd(handler func(TransitionEvent) Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt Event) Updates { return handler(buildTransitionEvent(evt)) }
...
func (h *TransitionHandler) OnTransitionRun(handler func(TransitionEvent) Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt Event) Updates { return handler(buildTransitionEvent(evt)) }
...
func (h *TransitionHandler) OnTransitionCancel(handler func(TransitionEvent) Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt Event) Updates { return handler(buildTransitionEvent(evt)) }
