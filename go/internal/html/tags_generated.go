...
func ForeignObject(items ...Item) *Element {
	return el(SVGForeignObjectElement{}, "foreignObject", items...)
}
...
func LinearGradient(items ...Item) *Element {
	return el(SVGLinearGradientElement{}, "linearGradient", items...)
}
...
func RadialGradient(items ...Item) *Element {
	return el(SVGRadialGradientElement{}, "radialGradient", items...)
}
