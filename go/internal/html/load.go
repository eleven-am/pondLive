...
func NewLoadHandler(ref dom.RefListener) *LoadHandler {
	return &LoadHandler{ref: ref}
}

// OnLoad registers a handler for the "load" event.
func (h *LoadHandler) OnLoad(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
	h.ref.AddListener("load", wrapped, LoadEvent{}.props())
}

// OnError registers a handler for the "error" event.
func (h *LoadHandler) OnError(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
...
func (h *LoadHandler) OnAbort(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
...
func (h *LoadHandler) OnLoadStart(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
...
func (h *LoadHandler) OnLoadEnd(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
...
func (h *LoadHandler) OnProgress(handler func(LoadEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildLoadEvent(evt)) }
...
func buildLoadEvent(evt dom.Event) LoadEvent {
