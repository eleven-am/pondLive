...
func NewAnimationHandler(ref dom.RefListener) *AnimationHandler {
	return &AnimationHandler{ref: ref}
}

// OnAnimationStart registers a handler for the "animationstart" event.
func (h *AnimationHandler) OnAnimationStart(handler func(AnimationEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildAnimationEvent(evt)) }
...
func (h *AnimationHandler) OnAnimationEnd(handler func(AnimationEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildAnimationEvent(evt)) }
...
func (h *AnimationHandler) OnAnimationIteration(handler func(AnimationEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildAnimationEvent(evt)) }
...
func (h *AnimationHandler) OnAnimationCancel(handler func(AnimationEvent) dom.Updates) {
	if h.ref == nil || handler == nil {
		return
	}
	wrapped := func(evt dom.Event) dom.Updates { return handler(buildAnimationEvent(evt)) }
...
func buildAnimationEvent(evt dom.Event) AnimationEvent {
