 ...
 */
export type EventSender = (event: { hid: string; payload: EventPayload }) => void;

/**
 * Navigation handler callback type
 */
export type NavigationHandler = (path: string, query: string, hash: string) => boolean;
...
function handleEvent(e: Event, eventType: string, sendEvent: EventSender): void {
 ...
 */
function shouldInterceptNavigation(e: MouseEvent, anchor: HTMLAnchorElement): boolean {
