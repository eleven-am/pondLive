...
var tags = []struct {
	...
	{"Menu", "menu", "Menu creates a <menu> element."},
	{"MenuItem", "menuitem", "MenuItem creates a <menuitem> element."},
	...
	{"Param", "param", "Param creates a <param> element."},
	{"Picture", "picture", "Picture creates a <picture> element."},
	{"Portal", "portal", "Portal creates a <portal> element."},
	...
	{"Rb", "rb", "Rb creates an <rb> element."},
	{"Rtc", "rtc", "Rtc creates an <rtc> element."},
	...
	{"ForeignObject", "foreignObject", "ForeignObject creates a <foreignObject> element."},
	{"G", "g", "G creates a <g> element."},
	{"Image", "image", "Image creates an <image> element."},
	...
	{"SvgText", "text", "SvgText creates an SVG <text> element."},
